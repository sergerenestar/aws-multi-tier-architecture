...
# ------------------------------------------------------------
# EC2 Bootstrap (Amazon Linux 2023) + Observability
# ------------------------------------------------------------
# Terraform injects these values:
#   NAME, ENVIRONMENT
...
# ---- IMDSv2 (region detection for CW Agent) ----
get_imds_token() {
...
# ---- systemd service (log to file so CW agent can ship it) ----
